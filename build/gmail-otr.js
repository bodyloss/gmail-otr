...
;(function () {
  ...
  OTR.prototype.io = function (msg) {
    ...
    // If we have no send_interval or fragment_size then trigger send immidiatly
    // without call to setTimeout.
    // This ensures that calling code doesn't have other events fire of before the message
    // has been sent
    if (this.send_interval == 0 && this.fragment_size == 0) {
        this.trigger('io', [msg]);
        return;
    }
